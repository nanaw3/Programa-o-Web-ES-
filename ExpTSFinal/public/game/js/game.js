...
function updateHUD() {
  ...
  for (let i = 0; i < lives; i++) {
    ...
    lifeImg.src = "/game/assets/png/life.png"
    lifeImg.alt = "Vida"
...
function checkShipCollision() {
  ...
  for (const enemy of enemies) {
    ...
    if (isColliding) {
      ...
      ship.element.src = "/game/assets/png/playerDamaged.png"

      setTimeout(() => {
        ship.element.src = "/game/assets/png/player.png"
      }, 5000)
...
function showGameOver() {
  ...
  fetch('/game-session', {
    ...
    if (res.ok) {
      ...
      console.error('Erro ao salvar score :((')
    }
  })
